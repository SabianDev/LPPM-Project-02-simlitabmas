    ...
    <div class="py-2">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="p-4 m-8 sm:p-8 bg-white shadow sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('program_studi.update', $programStudi->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="mb-4">
                        ...
                        <input type="text" name="namaProdi" id="namaProdi" value="{{ old('namaProdi', $programStudi->namaProdi) }}" required
